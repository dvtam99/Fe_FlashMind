		...
		<Form className="m-4" onSubmit={formik.handleSubmit}>
		  ...
		  <Form.Group>
		 	 <Form.File 
				...
				data-browse="Upload"
				onChange={(e) => formik.values.avatar= `http://localhost:5000/public/images/${e.target.files[0].name}`} 
				custom
			/>
			</Form.Group>
		  ...
		  <Button variant="primary" type="submit" style={{width: 150, margin: '0 auto'}}>
            Add
          </Button>
